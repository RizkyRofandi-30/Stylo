...
<div class="w-full flex flex-col gap-8 md:gap-0 md:flex-row px-4 lg:px-16 ">
    ...
    <div class="bg-gray-50 rounded-md p-4 md:p-8 flex-1">
        ...
        {{-- Total Summary --}}
        <div class="mt-8 space-y-2 border-t border-gray-200 pt-6 ">
            <div class="flex justify-between">
                <span class="text-[1rem] text-gray-500">Subtotal</span>
                <span class="text-[1rem] font-medium text-gray-800">$56.00</span>
            </div>
            <div class="flex justify-between">
                <span class="text-[1rem] text-gray-500">Shipping Cost</span>
                <span class="text-[1rem] font-medium text-gray-800">$8.00</span>
            </div>
            <div class="flex justify-between pb-3">
                <span class="text-[1rem] text-gray-500">Discount (10%)</span>
                <span class="text-[1rem] font-medium text-gray-800">-$13.00</span>
            </div>
        ...
        <form method="#" action="#" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <select name="country_code"
                        class="border rounded px-3 py-2 border-gray-200 outline-none hover:border-blue-700 mt-0.5 w-[100px]">
            ...
            <div>
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <label
                        class="flex-1 flex items-center justify-between gap-2 border-gray-200 border rounded-lg p-4">
                        <div>
            ...
            <div>
                <label for="billingAddress" class="text-[1rem] font-medium text-gray-800 mb-1">Billing address</label>
                <select id="billingAddress" name="billing_address"
                    class="w-full border rounded px-3 py-2 border-gray-200 outline-none hover:border-blue-700 mt-0.5">
