        ...
        <div class="card-wrapper">
            <ul class="card-list swiper-wrapper">
                <li class="card-item swiper-slide">
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <div class="relative group">
                            <img src="{{ asset('assets/images/men-01.jpg') }}" alt="Air Force 1 X"
                ...
                <li class="card-item swiper-slide">
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <div class="relative group">
                            <img src="{{ asset('assets/images/men-02.jpg') }}" alt="Air Force 1 X"
                                class="w-full h-150 xl:h-80 lg:h-80 md:h-80 sm:h-160 object-cover">
                            <div
                                class="absolute inset-0 backdrop-blur-sm flex justify-center items-center opacity-0 group-hover:opacity-100 transition">
                                <ul class="flex space-x-4">
                        ...
                        <div class="p-4">
                            <h4 class="text-xl font-bold">Air Force 1 X</h4>
                            <span class="text-gray-400 font-bold">$90.00</span>
                        </div>
                    </div>
                </li>
                <li class="card-item swiper-slide">
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        <div class="relative group">
                            <img src="{{ asset('assets/images/men-03.jpg') }}" alt="Love Nana '20"
                                class="w-full h-150 xl:h-80 lg:h-80 md:h-80 sm:h-160 object-cover">
                            <div
                                class="absolute inset-0 backdrop-blur-sm flex justify-center items-center opacity-0 group-hover:opacity-100 transition">
                                <ul class="flex space-x-4">
                        ...
                        <div class="p-4">
                            <h4 class="text-xl font-bold">Love Nana ‘20</h4>
                            <span class="text-gray-400 font-bold">$150.00</span>
                        </div>
                    </div>
                </li>
                <li class="card-item swiper-slide">
