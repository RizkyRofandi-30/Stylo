                    ...
                    <tbody>
                        @foreach ($packets as $item)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="p-2 border-b border-slate-200">
                                    <div class="flex items-center space-x-2">
                                        <img width="33" height="33"
                                            src="{{ asset('storage/' . $item->product_img) }}" alt="user"
                                ...
                                <td class="p-4 border-b border-slate-200">
                                    <p class="block text-sm text-slate-800">{{ $item->created_at ? $item->created_at->format('F j, Y') : '-' }}</p>
                                </td>
                                <td class="p-4 border-b border-slate-200">
                                ...
                                <td class="p-4 border-b border-slate-200 text-center">
                                    <div class="flex justify-center">
                                        <button data-modal-target="select-modal" data-modal-toggle="select-modal" data-id="{{ $item->id }}"
                        ...
                        <form id="edit-form" action="" method="POST">
                            ...
                            <div class="p-2 md:p-3">
                                <ul class="space-y-4 mb-4">
                                    <li>
                                        <input type="radio" id="Sedang_Diproses" name="PacketStatus" value="Sedang_Diproses"
                                            class="hidden peer"/>
